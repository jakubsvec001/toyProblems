...
BinaryHeap.prototype.swap = (arr, idx1, idx2) => {
  // use side effect on arr
  [arr[idx1], arr[idx2]] = [arr[idx2], arr[idx1]];
};

BinaryHeap.prototype.findParent = (idx) => {
  return Math.floor((idx - 1) / 2);
};

BinaryHeap.prototype.findChildren = (idx) => {
  return [idx * 2 + 1, idx * 2 + 2];
};

BinaryHeap.prototype.insert_test = function(value) {
  // TODO: Your code here
  this._heap.push(value);
};


BinaryHeap.prototype.bubbleRecursively = function(rootIdx) {
  const childLeft = this.findChildren(rootIdx)
...
// testing helpers
// console.log(BinaryHeap.prototype.findParent(31))
// console.log(BinaryHeap.prototype.findParent(32))
// console.log(BinaryHeap.prototype.findChildren(15))
